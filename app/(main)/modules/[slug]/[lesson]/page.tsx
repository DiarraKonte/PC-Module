  ...
  useEffect(() => {
    const checkIfMobile = () => {
      ...
      if (window.innerWidth >= 768) {
        setIsSidebarOpen(true); // Ouvrir automatiquement sur desktop
      }
    };
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-1 relative">
        <div className={`fixed md:static z-20 transition-transform duration-300 ease-in-out ${
        ...
        <main className="flex-1 container mx-auto py-8 px-4 transition-all duration-300">
